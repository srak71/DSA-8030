...
```{R fig.show='hold', echo=FALSE, out.width="7%", out.height="7%"}
knitr::include_graphics(c('Python-logo.png', 'C-logo.png', 'Java-logo.png', 'Matlab-logo.png', 'GoLang-logo.png'))
```
...
```{R fig.show='hold', echo=FALSE, out.width="7%", out.height="7%"}
knitr::include_graphics(c('MySQL-logo.png', 'R-logo.png', 'SAS-logo.png', 'SPSS-logo.png'))
```
...
```{R fig.show='hold', echo=FALSE, out.width="7%", out.height="7%"}
knitr::include_graphics('Apache-logo.png')
```
...
```{R fig.show='hold', echo=FALSE, out.width="7%", out.height="7%"}
knitr::include_graphics(c('PyTorch-logo.png', 'TensorFlow-logo.png'))
```
...
```{R fig.show='hold', echo=FALSE, out.width="7%", out.height="7%"}
knitr::include_graphics('x86-logo.png')
```
...
```{R fig.show='hold', echo=FALSE, out.width="7%", out.height="7%"}
knitr::include_graphics(c('Excel-logo.png', 'Sheets-logo.png'))
```
...
```{R fig.show='hold', echo=FALSE, out.width="7%", out.height="7%"}
knitr::include_graphics(c('Seaborn-logo.png', 'Ggplot2-logo.png', 'Tableau-logo.png'))
```
...
# Links {.tabset}
```{R fig.show='hold', echo=FALSE, out.width="7%", out.height="7%"}
knitr::include_graphics(c('LinkedIn-logo.png', 'GitHub-logo.png'))
```
...
You can download the R Markdown source code of this document [here](Portfolio.Rmd).
