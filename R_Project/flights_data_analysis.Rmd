...
An interactive shiny dashboard for flights data can be downloaded here: <https://github.com/srak71/DSA-8030/blob/main/R_Project/flights_flexdashboard.Rmd>
...
flights_data <- flights %>%
  ...
  mutate(was_delayed = (arr_delay > 0 | dep_delay > 0))
```
